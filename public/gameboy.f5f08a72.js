...
class GameboyPainter {
    ...
    paint(ctx, geom, props2) {
        const SCALE = 2;
        const { buttonA , buttonB , buttonLeft , buttonRight , buttonUp , buttonDown , buttonStart , buttonSelect ,  } = this.parseProps(props2);
...
},{"buffer":"lfRCg","./interface":"d0FxK","data-url:./mario.gb":"kp9cl","@parcel/transformer-js/src/esmodule-helpers.js":"5AFiq"}],"lfRCg":[function(require,module,exports) {
/*!
...
//# sourceMappingURL=gameboy.f5f08a72.js.map
